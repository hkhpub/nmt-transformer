...
from comm_utils.logs import logger
from comm_utils.misc import distribution_utils
from comm_utils.misc import model_helpers
...
def define_transformer_flags():
    ...
    flags.DEFINE_enum(
        name="param_set", short_name="ps", default="big",
