...
from official.comm_utils.flags import core as flags_core
from official.comm_utils.logs import logger
...
class BenchmarkLoggerTest(tf.test.TestCase):
  ...
  @mock.patch("official.comm_utils.logs.logger.config_benchmark_logger")
...
class BenchmarkFileLoggerTest(tf.test.TestCase):
  ...
  @mock.patch("official.comm_utils.logs.logger._gather_run_info")
