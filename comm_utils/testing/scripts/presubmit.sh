...
# usage: models >: ./official/comm_utils/testing/scripts/presubmit.sh
# usage: models >: ./official/comm_utils/testing/scripts/presubmit.sh lint py2_test py3_test
set +x
...
lint() {
  ...
  RC_FILE="comm_utils/testing/pylint.rcfile"
